...
export const villeferV1Package: AgentPackage = {
  "agent": {
    ...
    "followup": {
      ...
      "steps": [
        {
          "afterBusinessMinutes": 360,
          "instruction": "Use o contexto do pedido para confirmar o recebimento da proposta e perguntar qual é o principal bloqueio ou dúvida, sem pressionar por fechamento."
        },
        {
          "afterBusinessMinutes": 1200,
          "instruction": "Retome o contexto e ofereça ajuda concreta: esclarecer uma dúvida aprovada ou perguntar se o vendedor deve verificar alternativa de item, prazo, frete ou condição."
        },
        {
          "afterBusinessMinutes": 2400,
