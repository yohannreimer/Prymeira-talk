...
export const automationBlockCatalog: AutomationBlockDefinition[] = [
  ...
  { type: "run_agent", category: "integration", label: "Ativar agente", description: "Ativa um agente autônomo nesta conversa com agrupamento de mensagens.", support: "supported" },
